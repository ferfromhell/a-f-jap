...
export const japanConfig = {
  ...
  icon: '🇯🇵',
  title: 'Ana & Fer',
  subtitle: 'Japan Adventure 2026',
  badge: '🇯🇵 Japón Express · 7 días · Sakura + Kyoto + Nara + Osaka + teamLab',
  heroTitle: 'Itinerario Detallado y Optimizado',
  heroSubtitle: 'Salida desde Houston (IAH) → llegada a Tokyo (HND o NRT). Ritmo ágil pero realista, con opciones "si sobra energía".',
  emojis: ['✈️', '🌸'],
  summary: {
    title: 'Resumen rápido',
    items: [
      { label: 'Fechas', value: '28 Mar → 4 Abr (ajustable)' },
      { label: 'Ciudades', value: 'Tokyo · Kyoto · Nara · Osaka' },
      { label: 'Must-do', value: 'Torii rojos · Sakura · teamLab' },
      { label: 'Transporte', value: 'Suica/PASMO + Shinkansen' },
    ],
    notes: ['★ = súper turístico / imperdible', '⏱️ tiempos reales']
  },
  cities: ['Tokyo', 'Kyoto', 'Nara', 'Osaka']
};

function Japan({ expandAction }) {
  return (
    <>
